...
const Logo: FC<LogoProps> = ({ width = 72, height = 72 }) => {
  return (
    <>

  <div className="flex items-center text-primary-500  text-xl md:text-2xl">
    <svg
    ...
    <span className="font-extrabold  -ml-2 mr-1">Nimi </span>
